    ...
    <div id="container" class="container j-container">
        ...
        <div class="row">
            <div id="content" class="col-sm-12" style="margin-bottom:50px">
                ...
                <p>Perustimme ensimmäisen elintarvikekauppamme Helsinkiin vuonna 2008. Alunperin Alanya Marketin toiminta oli hyvin pientä, tilamme olivat mm. 500 m2 . Tänä päivänä tilamme ovat isommat ja olemme laajentaneet toimintaamme ketjuksi. Toinen kauppamme nimittäin perustettiin Tampereelle 2012. Olemme pienessä ajassa saavuttaneet paljon suosiota ja asiakkaamme ovat olleet erittäin tyytyväisiä palveluumme.</p>

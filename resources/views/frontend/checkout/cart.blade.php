                        ...
                        <table  v-show="!isCartEmpty" class="table table-bordered">
                            ...
                            <tbody>
                                <tr  v-for="product in cart.products">
                                    <td> <button style=" float: left; margin-top: 30px;" v-on:click="removeFromCart(product.product.id)" type="button" data-toggle="tooltip" title="" class="btn btn-danger" onclick="cart.remove('YToxOntzOjEwOiJwcm9kdWN0X2lkIjtpOjU3O30=');" data-original-title="Remove"><i class="fa fa-times-circle"></i></button></td>

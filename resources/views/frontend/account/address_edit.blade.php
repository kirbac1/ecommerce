      ...
      <form action="http://journal.digital-atelier.com/3/index.php?route=account/address/edit&amp;address_id=141" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="company" value="Safetracing Oy" placeholder="Company" id="input-company" class="form-control">
            </div>
          </div>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-address-1">Address 1</label>
            <div class="col-sm-10">
              <input type="text" name="address_1" value="New Factory Väinö Linnan aukio 15" placeholder="Address 1" id="input-address-1" class="form-control">
                          </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="postcode" value="33210" placeholder="Post Code" id="input-postcode" class="form-control">
                          </div>
          </div>
          <div class="form-group required">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <select name="zone_id" id="input-zone" class="form-control"><option value=""> --- Please Select --- </option><option value="1085" selected="selected">Ahvenanmaan Laani</option><option value="1086">Etela-Suomen Laani</option><option value="1087">Ita-Suomen Laani</option><option value="1088">Lansi-Suomen Laani</option><option value="1089">Lapin Lanani</option><option value="1090">Oulun Laani</option></select>
                          </div>
          </div>
                    <div class="form-group">

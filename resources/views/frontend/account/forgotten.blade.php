  ...
  <ul class="breadcrumb">
    ...
    <div class="row">                <div id="content" class="col-sm-12">
      <h1 class="heading-title">Forgot Your Password?</h1>
            <div class="content">
      <p class="account-text">Enter the e-mail address associated with your account. Click submit to have your password e-mailed to you.</p>
      <form  class="form-horizontal">
        <fieldset>
          <h2 class="secondary-title">Your E-Mail Address</h2>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-email">E-Mail Address</label>
            <div class="col-sm-10">
              <input type="text" v-model="customer.email1" name="email" value="" placeholder="E-Mail Address" id="input-email" class="form-control">
            </div>
          </div>
        </fieldset>
        <div class="buttons">

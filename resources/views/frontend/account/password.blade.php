                    ...
                    <form class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password" v-model="customer.password" value="" placeholder="Password" id="input-password" class="form-control">
                                </div>
                            </div>
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-confirm">Password Confirm</label>
                                <div class="col-sm-10">
                                    <input type="password" name="confirm"   v-model="customer.confirmPassword"  value="" placeholder="Password Confirm" id="input-confirm" class="form-control">
                                </div>
                            </div>
                        </fieldset>
                        <div class="buttons">

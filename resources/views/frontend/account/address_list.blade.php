...
<div class="carta-container"><div id="container" class="container j-container">
  <ul class="breadcrumb">
      ...
      <table class="table table-bordered table-hover">
          ...
          <td class="text-right"><a href="http://journal.digital-atelier.com/3/index.php?route=account/address/edit&amp;address_id=141" class="btn btn-info button">Edit</a> &nbsp; <a href="http://journal.digital-atelier.com/3/index.php?route=account/address/delete&amp;address_id=141" class="btn btn-danger button">Delete</a></td>
        </tr>
              </tbody></table>
      </div>
            <div class="buttons">
        ...
        <div class="pull-right"><a href="http://journal.digital-atelier.com/3/index.php?route=account/address/add" class="btn btn-primary button">New Address</a></div>
      </div>
      </div>
    </div>
</div>

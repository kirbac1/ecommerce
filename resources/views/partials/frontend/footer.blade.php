<footer class="boxed-footer">
    <div id="footer">
        <div class="row columns " style="background-color: rgb(63, 87, 101); background-repeat: repeat; background-position: center top; background-attachment: scroll; margin-bottom: 15px; padding-bottom: 15px">
            <div class="column  text xs-100 sm-50 md-50 lg-25 xl-25 no-title" style="height: 85px;">
                <div class="column-text-wrap">
                    ...
                    <h4>&nbsp;</h4>
                    <h3>Advanced Footer</h3>
                    <p>Create unlimited rows and columns</p>
                </div>
            </div>
            <div class="column  text xs-100 sm-50 md-50 lg-25 xl-25 no-title" style="height: 85px;">
                <div class="column-text-wrap">
                    ...
                    <p>Fit on any device from end to end</p>
                </div>
            </div>
            <div class="column  text xs-100 sm-50 md-50 lg-25 xl-25 no-title" style="height: 85px;">
                <div class="column-text-wrap">
            ...
            <div class="column  text xs-100 sm-50 md-50 lg-25 xl-25 no-title" style="height: 85px;">
                <div class="column-text-wrap">
                    ...
                    <h4>&nbsp;</h4>
                    <h3>16 Modules Included</h3>
                    <p>Unmatched module lineup</p>
                </div>
            </div>
        </div>
        <div class="row columns " style="background-attachment: scroll">
            <div class="column  menu xs-100 sm-50 md-33 lg-20 xl-20 " style="height: 225px;">
                ...
                <div class="column-menu-wrap">
                    <ul>
                        ...
                        <li><i style="margin-right: 5px; color: rgb(241, 196, 15); font-size: 16px" data-icon=""></i>{{ Setting::get('store_address1') }}</li>
                        <li><a href="http://alanyamarket.fi"><i style="margin-right: 5px; color: rgb(244, 244, 244); font-size: 16px" data-icon=""></i>Alanyamarket.fi</li>
                        <li><i style="margin-right: 5px; color: rgb(241, 98, 114); font-size: 16px" data-icon=""></i>{{  trans('messages.SLOGAN1') }}</li>
                        <li><i style="margin-right: 5px; color: rgb(183, 157, 186); font-size: 16px" data-icon=""></i>{{  trans('messages.SLOGAN2') }}</li>
                        <li><i style="margin-right: 5px; color: rgb(233, 232, 211); font-size: 16px" data-icon=""></i>{{  trans('messages.SLOGAN3') }}</li>
                        <li><i style="margin-right: 5px; color: rgb(76, 179, 86); font-size: 16px" data-icon=""></i>{{  trans('messages.SLOGAN4') }}</li>
                    </ul>
                </div>
            </div>
            <div class="column  menu xs-100 sm-50 md-33 lg-20 xl-20 " style="height: 225px;">
                ...
                <div class="column-menu-wrap">
                    <ul>
                        <li><a href="/about-us"><i style="margin-right: 5px; color: rgb(255, 255, 255); font-size: 14px; top: 1px" data-icon=""></i>{{ trans('messages.aboutUs') }}</a></li>
                        <li><a href="/delivery"><i style="margin-right: 5px; font-size: 14px; top: 1px" data-icon=""></i>{{  trans('messages.delivery') }}</a></li>
                        <li><a href="/privacy-policy"><i style="margin-right: 5px; color: rgb(255, 255, 255); font-size: 14px; top: 1px" data-icon=""></i>{{  trans('messages.privacy') }}</a></li>

                        <li><a href="/contact"><i style="margin-right: 5px; color: rgb(255, 255, 255); font-size: 14px; top: 1px" data-icon=""></i>{{  trans('messages.contact') }}</a></li>
                        <li><a href="/sitemap"><i style="margin-right: 5px; color: rgb(255, 255, 255); font-size: 14px; top: 1px" data-icon=""></i>{{  trans('messages.sitemap') }}</a></li>
            ...
            <div class="column  products xs-100 sm-50 md-33 lg-20 xl-20 " style="height: 232px;">
                <h3>{{  trans('messages.latest-products') }}</h3>
        ...
        <div class="row contacts" style="background-attachment: scroll; margin-bottom: 5px">
            <div class="contacts-left">
                <span class="hint--top" data-hint="Facebook"><a target="_blank" href="tel:0708-61 98 94"><i style="margin-right: 5px; color: rgb(255, 255, 255); font-size: 18px" data-icon=""></i><span class="contacts-text"></span></a>
                </span>
                <span class="hint--top" data-hint="Twitter"><a target="_blank" href="#"><i style="margin-right: 5px; color: rgb(255, 255, 255); font-size: 18px; top: 1px" data-icon=""></i><span class="contacts-text"></span></a>
                </span>

                <span class="hint--top"><a href="#"><i style="margin-right: 5px; color: rgb(255, 255, 255); font-size: 18px" data-icon=""></i><span class="contacts-text"></span></a>
                </span>
            </div>
        ...
        <div class="row columns " style="background-repeat: repeat; background-position: center top; background-attachment: scroll; padding-bottom: 15px">
            <div class="column  text xs-100 sm-100 md-100 lg-50 xl-50 no-title" style="height: 85px;">
                <div class="column-text-wrap">
                    <p>{{  trans('messages.explanation') }} <strong></strong></p>
                </div>
            </div>
            <div class="column  newsletter xs-100 sm-100 md-100 lg-50 xl-50 no-title" style="height: 85px;">
                <div class="box journal-newsletter text-top " id="journal-newsletter-1244129816" style="; ">
            ...
            <input type="text" class="newsletter-email" placeholder="{{  trans('messages.newsletter-placeholder') }}" style="border-radius: 40px">
            <a class="newsletter-button button" v-on:click="register2Newsletter" style="margin-top: -1px; right: 3px; border-radius: 40px; font-size: ; font-style: ; text-transform: ">{{  trans('messages.send') }}</a>
        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="bottom-footer boxed-bar">
        <div class="">
            ...
            <div class="payments">
                ...
                <img src="/assets/img/pay/nordea.png" alt="PayPal" width="51" height="32">
            </div>
        </div>
    </div>
</footer>
<script src="/assets/js/frontend_common.js"></script>
<script src="/assets/js/frontend_custom.js"></script>
<script src="/templates/assets/lib/owl.carousel.js"></script>

...
<body class="login-content">
    <div class="lc-block toggled" id="l-login">
        <div class="input-group m-b-20">
            ...
            <div class="fg-line">
                <input id="login-email" type="text" class="form-control" placeholder="{{ trans('messages.E-Mail') }}" v-model="email" @keyup.enter.prevent="doLogin">
            </div>
        </div>
        ...
        var vue = new Vue({
            ...
            methods: {
                doLogin: function doLogin() {
                    ...
                    Vue.http.post('/admin/login', credentials).then(function success(response) {

...
@section('page.title', trans('messages.Proformas'))
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th>{{ trans('messages.Proforma ID') }}</th>
                ...
                <tbody>
                    <tr v-for="(key, val) in objects | filterBy searchFilter" class="clickableRow">
                        <td>
                            <div class="checkbox m-b-15">
                                <label>
        ...
        var vue = new Vue({
            ...
            methods: {
                ...
                goToPage: function goToPage(val) {
                    ...
                    Vue.http.get('/api/v3/search/proformas/' + this.searchFilter, { limit: this.limit, start: ((this.start -1) * this.limit) }).then(function success(response) {
                ...
                goToOrder: function goToOrder() {
                    location.href = '/admin/orders/' + object.order.id + '/edit';
                },
                ...
                destroy: function destroy(event) {
                    ...
                    swal({
                        ...
                        that.objects.forEach(function(object) {
                            if (object.selected) {
                                Vue.http.delete('/api/v3/proformas/' + object.id);
                            }
                        });
                        swal({
                ...
                loadObjects: function loadObjects(query) {
                    if (!query) query = '';
                    Vue.http.get('/api/v3/search/proformas/' + query, { limit: this.limit, start: this.start - 1 }).then(function success(response) {

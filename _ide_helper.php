 ...
 * Generated for Laravel 5.2.31 on 2016-06-07.
 *
...
if (! function_exists('with')) {
    ...
    class PDF extends \PhantomPdf\Laravel\PDFFacade{
         ...
         * @return \PhantomPdf\BinaryFileResponse 
         * @static 
         */
        public static function createFromView($view, $filename){
            return \PhantomPdf\PdfGenerator::createFromView($view, $filename);
        }
         ...
         * @static 
         */
        public static function saveFromView($view, $path){
            return \PhantomPdf\PdfGenerator::saveFromView($view, $path);
        }
        ...
        public static function deleteTempFiles(){
            return \PhantomPdf\PdfGenerator::deleteTempFiles();
        }
         ...
         * @static 
         */
        public static function prefixHtmlPath($path){
            return \PhantomPdf\PdfGenerator::prefixHtmlPath($path);
        }
        ...
        public static function setBaseUrl($url){
            return \PhantomPdf\PdfGenerator::setBaseUrl($url);
        }
         ...
         * @static 
         */
        public static function setBinaryPath($path){
            return \PhantomPdf\PdfGenerator::setBinaryPath($path);
        }
        ...
        public static function getBinaryPath(){
            return \PhantomPdf\PdfGenerator::getBinaryPath();
        }
        ...
        public static function setStoragePath($path){
            return \PhantomPdf\PdfGenerator::setStoragePath($path);
        }
        ...
        public static function setTimeout($seconds){
            return \PhantomPdf\PdfGenerator::setTimeout($seconds);
        }
         ...
         * @static 
         */
        public static function addCommandLineOption($option){
            return \PhantomPdf\PdfGenerator::addCommandLineOption($option);
        }
         ...
         * @static 
         */
        public static function useScript($path){
            return \PhantomPdf\PdfGenerator::useScript($path);
        }

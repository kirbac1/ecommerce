  jQuery(document).ready(function() {
      ...
      $(".date").text(output);
      $(".due").text(due);
      var customer = localStorage.getItem("receiptCustomer");
    ...
    $(document).on('click', '.receipt', function(e) {
        ...
        var currentCustomer = localStorage.getItem("receiptCustomer");
        ...
        order.country = currentCustomer.country;
            ...
            $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.get("/api/v3/orders/" + data.id + '/convertToReceipt', function(data) {


                                    localStorage.setItem("receiptID", data.id);
                                                    window.open(
                    '/api/v3/receipts/'+data.id+'/renderItem',
